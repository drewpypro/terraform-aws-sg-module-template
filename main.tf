...
locals {
  ...
  security_groups = {
    ...
    "autoscaling"               = "vpce_autoscaling"
    "dms"                       = "vpce_dms"
    "ec2"                       = "vpce_ec2"
    "ec2messages"               = "vpce_ec2messages"
    "efs"                       = "vpce_efs"
    "eks"                       = "vpce_eks"
    "elasticache"               = "vpce_elasticache"
    "elasticloadbalancing"      = "vpce_elasticloadbalancing"
    "kms"                       = "vpce_kms"
    "lambda"                    = "vpce_lambda"
    "logs"                      = "vpce_logs"
    "monitoring"                = "vpce_monitoring"
    "rds"                       = "vpce_rds"
    "s3"                        = "vpce_s3"
    "sns"                       = "vpce_sns"
    "sqs"                       = "vpce_sqs"
